...
#include <Servo.h>
#include <SPI.h>
SoftwareSerial SIM900(11, 10); // SoftwareSerial SIM900(Rx, Tx)
...
char initial_password[4] = {'5', '6', '2', '3'};  // Variable to store initial password
String tagUID = "D1 91 1E 69";  // String to store UID of tag. Change it with your tag's UID
...
void send_message(String message)
{
  ...
  delay(100);
  SIM900.println("AT+CMGS=\"+919975617490\""); // Replace it with your mobile number
  delay(100);
